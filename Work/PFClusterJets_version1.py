##############################################################
### Created on Dec/3rd/2014 Yongjie Xin ######################
### Based on the copy of L2PF.py #############################
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    #fileName = cms.untracked.string('PFL2_out_All.root'),
    fileName = cms.untracked.string('PFL2_out_All10000Events.root'),
...
process.hltL2PFJets = cms.EDProducer("FastjetJetProducer",
    ...
    rParam = cms.double(0.4)  # these are AK4 jets
) 
...
#process.load("PFClusterProducer.particleFlowClusterECAL")
...
#pfClusterRefsForJets.src = cms.VInputTag( "pfClusterRefsForJetsHCAL", "pfClusterRefsForJetsECAL","pfClusterRefsForJetsHF" )

process.ak4PFClusterJets = cms.EDProducer(
    "FastjetJetProducer",
