# /users/gennai/CMSSW_7_2_1_patch2_HLT1/PFlow_HCAL_test/V5 (CMSSW_7_2_1_patch2_HLT1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/gennai/CMSSW_7_2_1_patch2_HLT1/PFlow_HCAL_test/V5')
)

process.streams = cms.PSet(  A = cms.vstring( 'Jets' ) )
process.datasets = cms.PSet(  Jets = cms.vstring( 'HLT_PFJet40_v1' ) )
...
process.hltParticleFlowClusterHBHETimeSelected = cms.EDProducer(
    "PFClusterTimeSelector",
    src = cms.InputTag('hltParticleFlowClusterHBHE'),
    cuts = cms.VPSet(
        cms.PSet(
...
process.hltParticleFlowClusterHCALMultiDepth = cms.EDProducer("PFMultiDepthClusterProducer",
    pfClusterBuilder = cms.PSet(
    ...
    clustersSource = cms.InputTag("hltParticleFlowClusterHBHETimeSelected")
)
...
process.hltParticleFlowBlockL2 = cms.EDProducer("PFBlockProducer",
    ...
    elementImporters = cms.VPSet(
        ...
        cms.PSet(
            source = cms.InputTag("hltParticleFlowClusterHCALMultiDepth"),
            importerName = cms.string('GenericClusterImporter')
        ), 
        cms.PSet(
...
process.hltFakeVertices =cms.EDProducer("FakeVertexProducer",
...
process.hltParticleFlowL2 = cms.EDProducer("PFProducer",
    ...
    vertexCollection = cms.InputTag("hltFakeVertices"),
...
process.hltOutputA = cms.OutputModule( "PoolOutputModule",
    ...
    outputCommands = cms.untracked.vstring( 'keep *_hltAK4CaloJetsCorrectedIDPassed_*_*',
      'keep *_ak4GenJetsNoNu_*_*',                                      
      'keep *_hltAK4CaloJetsCorrected_*_*',
      'keep *_hltAK4CaloJets_*_*',
      'keep *_hltAK4PFJetsCorrected_*_*',
      'keep *_hltAK4PFJets_*_*',
      'keep *_hltL2PFJets_*_*',
...
###L2 PFJets
process.HLTL2PFJetsSequence = cms.Sequence(process.hltParticleFlowRecHitECALUnseeded+
...
process.hltParticleFlowClusterHBHETimeSelected+
process.hltParticleFlowClusterHCALMultiDepth +
process.hltParticleFlowClusterHF+
process.hltParticleFlowClusterHO+
process.hltParticleFlowBlockL2+
process.hltFakeVertices+
...
process.HLT_PFJet40_v1 = cms.Path( process.HLTBeginSequence + process.hltPrePFJet40 + process.HLTAK4CaloJetsSequence + 
process.HLTAK4PFJetsSequence +
process.HLTL2PFJetsSequence +
...
#'/store/mc/Fall13/QCD_Pt-5to3000_Tune4C_Flat_13TeV_pythia8/GEN-SIM/POSTLS162_V1-v1/00000/FED46599-4E12-E411-B550-02163E00ECE3.root' 
'/store/relval/CMSSW_7_2_0_pre8/RelValQCD_FlatPt_15_3000HS_13/GEN-SIM-DIGI-RAW-HLTDEBUG/PHYS14_25_V1_Phys14-v1/00000/028A51DE-F053-E411-BF0F-0025905964C2.root'
   ),
...
if 'GlobalTag' in process.__dict__:
    ...
    process.GlobalTag = customiseGlobalTag(process.GlobalTag, globaltag = 'MCRUN2_72_V3A') #This is for 25 n
#    process.GlobalTag = customiseGlobalTag(process.GlobalTag, globaltag = 'MCRUN2_72_V4A') #This is for 50 n
